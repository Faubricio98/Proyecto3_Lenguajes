#pragma checksum "C:\Users\congr\source\repos\Proyecto3_Lenguajes\Views\RegistraCentro\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6f2f0d593608c21085591003b5b7b35885842b5a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6f2f0d593608c21085591003b5b7b35885842b5a", @"/Views/RegistraCentro/Index.cshtml")]
        ...
        <div class=""col-md-6"">
            <div class=""row"">
                <div id=""CTA"" class=""col-md-10 text-center rounded"" style="" background-color: #ffffff; margin-top: 2em; margin-bottom: 4em;"">
                    ...
                    <textarea class=""form-control"" id=""bussinesDesc"" placeholder=""Describa su negocio"" style=""margin-top: 1em;""></textarea>
                    <div class=""row"">
                        <div class=""col"">
                            <input id=""bussinesProv"" type=""t");
            WriteLiteral(@"ext"" class=""form-control"" style=""margin-top: 1em;"" placeholder=""Provincia"">
                        </div>
                        <div class=""col"">
                    ...
                    <input id=""bussinesPhone"" type=""text"" class=""form-control"" style=""margin-top: 1em;"" placeholder=""Teléfono"">
            ...
            WriteLiteral(@"v class=""col"">
                    ...
                    <div class=""custom-file"" style=""margin-top: 1em;"">
                        <input type=""file"" class=""custom-file-input"" id=""fileChooserLogo"" required>
                        <label class=""custom-file-label"" for=""fileChooserLogo"">Seleccione su logo</label>
                    </div>
                    <div class=""custom-file"" style=""margin-top: 1em;"">
                        <input type=""file"" class=""custom-file-input"" id=""fileChooserImages"" required>
                        <label class=""custom-file-label"" for=""fileChooserIma");
            WriteLiteral(@"ges"">Imágenes del Centro de Entrenamiento</label>
                    </div>

                    <a class=""btn btn-outline-primary"" onclick=""btnVerRegistraCentro($('#bussinesName').val())"" style=""margin-top: 1em; margin-bottom: 2em""> Registrar </a>
                </div>
